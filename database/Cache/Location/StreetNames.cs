...
{
    internal class StreetNamesCache : GroupCache<CachedStreetName.GroupKey, int, CachedStreetName.NameKey, CachedStreetName, byte, BizSrt.Data.AppDbContext>
    {
        internal StreetNamesCache()
            ...
            }, (BizSrt.Data.AppDbContext dc, CachedStreetName.NameKey key2, object data) =>
            {
        ...
        protected override int Created(BizSrt.Data.AppDbContext dc, BizSrt.Foundation.Cache.IKey<int> streetName, object data)
        {
    ...
    internal class CachedStreetName : BizSrt.Foundation.Cache.IKey<int>, BizSrt.Foundation.Cache.IMemberType<byte>
    {
        ...
        int BizSrt.Foundation.Cache.IKey<int>.Key
        {
            get { return Id; }
        }

        bool BizSrt.Foundation.Cache.IMemberType<byte>.OfType(byte type)
        {
            return true;
        }
