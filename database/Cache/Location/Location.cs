...
namespace BizSrt.Data.Cache.Location
{
    ...
    internal class CachedLocation : CachedNode<int>
    {
        ...
        public override CachedNode<int, byte> Parent
        {
            get
            {
                return (ParentKey >= 0 ? BizSrt.Data.Cache.LegacyCache.Locations[ParentKey] : null);
            }
        }
        ...
        public override Node<int> ParentNode(byte type)
        {
            if (ParentKey >= 0)
            {
                var parentLocation = BizSrt.Data.Cache.LegacyCache.Locations[ParentKey] as CachedLocation;
        ...
        internal BizSrt.Model.LocationRef PopulateWithPath()
        {
            ...
            if (parent != null)
            {
                ...
                {
                    var locationSettings = BizSrt.Data.Cache.LegacyCache.LocationSettings[0];
