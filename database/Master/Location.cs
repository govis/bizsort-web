        ...
        public static class Location
        {
            ...
            internal static Model.Location Resolve(Model.Geocoder.City city, Model.Location location, int parentId, bool allowCreate)
            {
                ...
                try
                {
                    ...
                    {
                        location.Id = LegacyCache.Locations[new BizSrt.Data.Cache.Location.CachedLocation.NameKey
                        {
                            Parent = parentId,
                            Type = location.Type,
                            Name = location.Name
                ...
                BizSrt.Model.LocationSettings locationSettings;
            ...
            internal static BizSrt.Data.Cache.Location.CachedLocation resolveByArea(BizSrt.Data.Cache.Location.CachedLocation[] locations, string areaName)
            {
                if (locations != null)
                {
            ...
            internal static LocationType resolveLocationGap(Model.Geocoder.City city, int parentId, LocationType locationType, string locationName)
            {
                ...
                BizSrt.Data.Cache.Location.CachedLocation areaLocation; string areaName;
                ...
                if (childType != LocationType.Unknown)
                {
                    foreach (var location in locations)
                    {
                        ...
                        if (location.Type == LocationType.City)
                        {
                            ...
                            {
                                areaLocation = resolveByArea(new BizSrt.Data.Cache.Location.CachedLocation[] { location }, city.Area);
                                if (areaLocation != null)
                                {
            ...
            internal static bool fillLocationValue(Model.Geocoder.City city, LocationType locationType, BizSrt.Data.Cache.Location.CachedLocation location, bool reset)
            {
            ...
            public static Node<int> /*Interface.Master.ILocation.*/PopulateWithChildren(int parentLocation, BizSrt.Model.Group.SubType type)
            {
                if (parentLocation >= 0)
                {
