...
public class Location : BizSrt.Foundation.Cache.IKey<int>
{
    [Key]
    public int Id { get; set; }
    int BizSrt.Foundation.Cache.IKey<int>.Key => Id;
    public int? Parent { get; set; }
...
public class StreetName : BizSrt.Foundation.Cache.IKey<int>
{
    [Key]
    public int Id { get; set; }
    int BizSrt.Foundation.Cache.IKey<int>.Key => Id;
