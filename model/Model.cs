...
namespace BizSrt.Model
{
    ...
    namespace List
    {
        ...
        public class SearchOutput<T> : QueryOutput<T>
        {
            ...
            public BizSrt.Model.Semantic.FacetName[]? Facets { get; set; }
        }
    ...
    public class LocationRef : BizSrt.Model.Group.NodeRef<int>
    {
...
namespace BizSrt.Model.Product
{
    ...
    {
        public class Type : BizSrt.Model.DictionaryItem<byte>
        {
...
namespace BizSrt.Model
{
    ...
    public partial class ServiceType : DictionaryItem<long>
    {
        public const long Any = int.MaxValue;
    ...
    public partial class Industry : DictionaryItem<long>
    {
        public const long Any = int.MaxValue;
    }

    public partial class TransactionType : DictionaryItem<short>
    {
        public const byte Default = 7;
    ...
    public class Currency : DictionaryItem<byte>
    {
        public enum ItemType : byte
        {
            CAD = 1,
