...
public class CachedCompanyProduct : PartCache, IKey<long>, IExpirationItem
{
    ...
    public ImageEntity ImageEntity => (ImageId == 0 && Type == (short)BizSrt.Api.Model.Product.ProductType.ItemType.Service) 
        ? ImageEntity.Service 
        : ImageEntity.Product;
    ...
    public Preview ToPreview(Action<Preview, CachedCompanyProduct>? populate = null)
    {
        ...
        { 
            Id = Id,
            Name = Title,
            Type = new BizSrt.Api.Model.Product.ProductType { ItemKey = Type, ItemText = "Product" },
            WebUrl = WebUrl,
            Text = PreviewText,
            Date = Created,
            Image = Image
