using LocationRef = BizSrt.Api.Model.LocationRef;
using System;
using System.Linq;
...
{
    internal class LocationsCache : TreeCache<int, CachedLocation.NameKey, CachedLocation, byte, BizSrt.Api.Data.AppDbContext>
    {
        internal LocationsCache()
            ...
            }, (BizSrt.Api.Data.AppDbContext dc, CachedLocation.NameKey key2, object data) =>
            {
                ...
                {
                    var l = new BizSrt.Api.Data.Entities.Location();
        ...
        protected override int Created(BizSrt.Api.Data.AppDbContext dc, BizSrt.Api.Foundation.Cache.IKey<int> location, object data)
        {
            _updated = true;
            var parent = (int)data;
            DropGroup(parent);
    ...
    internal class CachedLocation : CachedNode<int>
    {
        ...
        public override BizSrt.Api.Model.Group.NodeType NodeType(byte type)
        {
            return (_type == (byte)LocationType.City ? BizSrt.Api.Model.Group.NodeType.Class : BizSrt.Api.Model.Group.NodeType.Super);
        }

        internal BizSrt.Api.Model.LocationRef PopulateWithPath()
        {
            BizSrt.Api.Model.LocationRef model = new BizSrt.Api.Model.LocationRef { Id = _id, Name = _name, Type = Type };
        ...
        internal LocationRef EntityRef(BizSrt.Api.Model.Group.DisplayType type)
        {
