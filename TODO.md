...
- [ ] **Offering Slider**: Port the featured offerings carousel.
...
- `articles`, `feed`, `job`, `jobs`, `marketplace`, `news`, `offering`, `offerings`, `project`, `projects`, `promotions`, `search`.

## 6. SEO Metadata & JSON-LD
- [x] Basic dynamic SEO injection via `.astro` frontmatter.
- [ ] Full JSON-LD schema generation for companies and offerings server-side.
