...
export class OfferingListView extends LitElement implements IViewAdapter {
...
if (!customElements.get('offering-listview')) {
    customElements.define('offering-listview', OfferingListView);
}
